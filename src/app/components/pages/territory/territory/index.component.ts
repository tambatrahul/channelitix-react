...
export class TerritoryComponent extends ListComponent {
   ...
   * @param territory_id
   */
  prepareLink(territory_id) {
      return '/territories/zones/' + this._zone_id + '/regions/' +  this._region_id + '/areas/' + this._area_id + '/headquarters/' +
        this._headquarter_id + '/territories/' + territory_id + '/bricks';
  }
}

...
export class CustomerMissingComponent extends ListComponent {
  ...
  fetch() {
    this.loading = true;
    this.customer_others = 0;
    this.customer_retailer = 0;
    this.customer_hub_chemist = 0;
    this.customer_physician = 0;
    this.customer_semi = 0;
    this.total_customer_others = 0;
    this.total_customer_retailer = 0;
    this.total_customer_hub_chemist = 0;
    this.total_customer_physician = 0;
    this.total_customer_semi = 0;

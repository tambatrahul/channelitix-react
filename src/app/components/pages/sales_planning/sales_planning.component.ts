...
export class SalesPlanningComponent extends ListComponent {
    ...
    total_updated() {
        ...
        this.customers.map(cus => {
            ...
            this.total_customer.plans[5].primary_sale += cus.plans[5].primary_sale;
            this.total_customer.plans[2].primary_sale += cus.plans[2].primary_sale;
            this.total_customer.plans[7].primary_sale += cus.plans[7].primary_sale;
            this.total_customer.plans[0].primary_sale += cus.plans[0].primary_sale;

            this.total_customer.plans[5].secondary_sale += cus.plans[5].secondary_sale;
            this.total_customer.plans[2].secondary_sale += cus.plans[2].secondary_sale;
            this.total_customer.plans[7].secondary_sale += cus.plans[7].secondary_sale;
            this.total_customer.plans[0].secondary_sale += cus.plans[0].secondary_sale;
        });
    }

...
export class ProductSalePlanComponent extends ListComponent {
    ...
    primary_paln: number = 0;
    secondary_paln: number = 0;
    system_pri_paln: number = 0;
    ...
    protected format_data() {
        ...
        this.month_target = 0;
        this.primary_paln = 0;
        this.secondary_paln = 0;
        this.system_pri_paln = 0;
        ...
        this.brands.map(brand => {
            ...
            this.primary_paln += brand.primary_sale;
            this.secondary_paln += brand.secondary_sale;
            this.system_pri_paln += brand.system_primary_plan;

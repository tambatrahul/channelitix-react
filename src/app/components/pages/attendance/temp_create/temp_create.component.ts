...
@Component({
  selector: 'temp-create-attendance',
  templateUrl: 'temp_create.component.html',
  styleUrls: ['temp_create.component.less']
})
export class TempCreateAttendanceComponent extends FormComponent {
  ...
  save() {
    ...
    if (this.form.valid) {
      ...
      this.attendanceService.temp_create(data).subscribe(
        response => {
          this.loading = false;
          this.reset();

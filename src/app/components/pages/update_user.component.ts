...
@Component({
  templateUrl: '../../templates/pages/update_user.component.html',
...
export class UpdateUserComponent extends FormComponent {
   ...
   * @param _service
   */
  constructor(public userService: UserService, public _router: Router, public route: ActivatedRoute, public _fb: FormBuilder,

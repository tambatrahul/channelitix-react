...
@Component({
    selector: 'product-wise-sale-sk',
    styleUrls: ['product_wise_sale_for_sk.component.less'],
    templateUrl: 'product_wise_sale_for_sk.component.html',
    inputs: ['refresh']
})
export class ProductWiseSaleForSKComponent extends BaseDashboardComponent {
    ...
    protected fetch() {
        if (this._month && this._year) {
            this.loading = true;
            this.reportService.product_wise_sale_for_sk(this._month + 1, this._year,

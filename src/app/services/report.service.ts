...
export class ReportService extends BaseService {
  ...
  sales(month: number, year: number) {
    return this.get(this.getBaseUrl() + '/dashboard/sales/' + month + "/" + year, new RequestOptions({}));
  }
  ...
  sales_yearly(year: number) {
    return this.get(this.getBaseUrl() + '/dashboard/sales_yearly/' + year, new RequestOptions({}));
  }

export class YearStockistSale {
    ...
    constructor(info: any) {
        ...
        if (info.yearly_stockist_sale)
            this.yearly_stockist_sale = parseFloat((parseFloat(info.yearly_stockist_sale) / 10000).toFixed(0));
        ...
        if (info.yearly_stockist_sale_ab)
            this.yearly_stockist_sale_ab = parseFloat((parseFloat(info.yearly_stockist_sale_ab) / 10000).toFixed(0));
